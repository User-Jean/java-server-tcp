...
public class TCPServerConfiguration {
    ...
    @Bean(value = TCP_DEFAULT_CHANNEL)
    public MessageChannel messageChannel() {
        return new DirectChannel();
    }

    @Bean
    public TcpInboundGateway messageHandler(AbstractServerConnectionFactory serverConnectionFactory,
                                            @Qualifier(TCP_DEFAULT_CHANNEL) MessageChannel messageChannel) {
